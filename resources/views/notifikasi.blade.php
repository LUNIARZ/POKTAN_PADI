    ...
    <main class="halaman-notifikasi">
        ...
        <section class="konten-notifikasi">
            <article class="kartu-notifikasi">
                <div class="ringkasan-notifikasi">
                    <div>
                        <span>Belum dibaca</span>
                        <strong data-jumlah-belum-dibaca>0</strong>
                    </div>
                    <button type="button" data-baca-semua disabled>Tandai semua dibaca</button>
                </div>
                ...
                <div class="daftar-tabel-kecil" id="filter-notifikasi" aria-label="Kategori notifikasi" data-filter-panel>
                    ...
                    <table class="tabel-kecil" role="button" tabindex="0" data-filter="sistem">
                        <tbody>
                            <tr>
                                <td>Sistem</td>
                            </tr>
                ...
                <div class="daftar-notifikasi" data-daftar-notifikasi data-notifikasi-pembelian-marketplace>
                    <article class="notifikasi-kosong">
