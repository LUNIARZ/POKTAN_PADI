...
<body>
    <main class="halaman-profile">
        ...
        <section class="konten-profile">
            ...
            <section class="menu-profile" aria-label="Menu profile pembeli">
                <a href="{{ route('pembeli.data-diri') }}" class="item-menu-profile">
                    ...
                    <span class="teks-menu-profile">
                        ...
                        <small>Kelola informasi pembeli Anda</small>
                    </span>
                ...
                <a href="{{ route('pembeli.pesanan') }}" class="item-menu-profile">
                    ...
                    <span class="teks-menu-profile">
                        ...
                        <small>Lihat pesanan produk petani</small>
                    </span>
                    <svg class="panah-menu" viewBox="0 0 24 24" fill="none" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                        <path d="m9 18 6-6-6-6"></path>
                    </svg>
